...
pub struct PassportPolicy {
    ...
    /// Passport associated with this policy. Empty string if created without
    /// a passport binding (the binding is established later during provisioning).
    #[serde(default)]
...
impl From<&PassportPolicyPermit> for PassportPolicyPermitPayload {
    fn from(permit: &PassportPolicyPermit) -> Self {
        Self {
            ...
            passport_id: permit.passport_id.clone(),
